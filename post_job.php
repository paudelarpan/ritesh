...
if (isset($_POST["submit"])) {
    ...
    if ($connect) {
        ...
        if ($insert) {
            echo '<script>alert("Congrats! Job posted successfully."); window.location.href="employer_home.php";</script>';
        } else {
            echo '<script>alert("Sorry! Submission unsuccessful. Error: ' . mysqli_error($connect) . '"); window.location.href="post_job.php";</script>';
        }
